...
public class MetaFile {
	 ...
	 * 
	 * @param file
	 *            - the font file string.
	 */
	protected MetaFile(String file) {
		this.aspectRatio = (double) Game.width / (double) Game.height;
		openFile(file);
		loadPaddingData();
		loadLineSizes();
	...
	private void openFile(String file) {
		try {
			InputStreamReader in = new InputStreamReader(Class.class.getResourceAsStream("/res/font/" + file + ".fnt"));
