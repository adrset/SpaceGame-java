...
public class Light extends CelestialBody{
	...
	private Vector3f attenuation = new Vector3f(1, 0 , 0);//infinite distance light

	public Light(TexturedModel model, Vector3f position, Vector3f color, Vector3f attenuation, float radius, float density) {
